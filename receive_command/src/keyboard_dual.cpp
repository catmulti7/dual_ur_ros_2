...
public:
    ...
    {
        control_command_left = this -> create_publisher<robot_control_msgs::msg::Pose>("/arm_1/control_command",10);
        control_command_right = this -> create_publisher<robot_control_msgs::msg::Pose>("/arm_0/control_command",10);
...
void ReceiveCommand::getKeyboardInput()
{
    ...
    {
        control_value_right.dy = 20;
        control_command_right -> publish(control_value_right);
        return;
    }
    else if(key == 105)//I
    {
        control_value_right.dx = 20;
        control_command_right -> publish(control_value_right);
        return;
    }
    else if(key == 107)//K
